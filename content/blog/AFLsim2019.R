...
#transpose data to tidy form for use in ggplot
SimResultstanh.2019 <- SimResultsList.2019[[20]]
SimResultstanh.2019$simNumber <- sprintf("sim%d", seq(1:Nsim.tanh.2019))
SimResultstanh.2019.tidy <- gather(SimResultsList.2019[[20]],"Team", "Position", -simNumber)

#create ordered factor to order graph
SimResultstanh.2019.tidy$Team <- factor(SimResultstanh.2019.tidy$Team, levels = Finalsimtabletanh.2019$Team)
